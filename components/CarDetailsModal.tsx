"use client"; // Headless UI uses client-side rendering
...
interface CarDetailsModalProps { 
    ...
    // In fact, in this case it's probably better because we use our types file when defining a property (CarProps) for this component
    isOpen: boolean;
    closeModal: () => void;
    car: CarProps;
}
                        ...
                        <Dialog.Panel className="
                            ...
                            <div className='flex-1 flex flex-col gap-2'>
                                ...
                                <div className="mt-3 flex flex-wrap gap-4">
                                    {/* Object.entries allows use to return not only the values, 
                                    but the keys (aka names/categories) themselves*/}
